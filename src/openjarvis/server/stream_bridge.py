        ...
        try:
            ...
            try:
                ...
                if "context length" in error_str.lower() or (
                    ...
                    error_content = (
                        "A entrada é longa demais para a janela de contexto do modelo. "
                        "Tente uma mensagem mais curta."
                    )
                elif "400" in error_str:
                    error_content = f"O modelo retornou um erro: {error_str}"
                else:
                    error_content = f"Desculpe, ocorreu um erro: {error_str}"
