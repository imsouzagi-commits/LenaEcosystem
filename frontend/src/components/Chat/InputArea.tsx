    ...
    <div className="px-4 pb-4 pt-2" style={{ maxWidth: 'var(--chat-max-width)', margin: '0 auto', width: '100%' }}>
      ...
      >
        <textarea
          ...
          style={{ color: 'var(--color-text)', maxHeight: '200px', fontFamily: 'Apple Color Emoji, Segoe UI Emoji, Noto Color Emoji, sans-serif' }}
        ...
        {streamState.isStreaming ? (
          ...
          <div className="flex items-center gap-1">
            <div className="relative" ref={emojiPickerRef}>
              ...
              {emojiOpen && (
                <div
                  className="absolute bottom-full right-0 z-10 mt-2 w-64 rounded-2xl border border-solid p-3 shadow-xl"
                  ...
                  <div className="grid grid-cols-8 gap-2">
                    {EMOJIS.map((emoji) => (
                      <button
                        ...
                        className="text-lg leading-none rounded-lg p-2 transition-colors hover:bg-[rgba(255,255,255,0.08)]"
